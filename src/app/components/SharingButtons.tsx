...
export default function SharingButtons() {
  const encodedText = encodeURIComponent('باقي');
  const encodedUrl = encodeURIComponent('https://ahimta.github.io/bagi/');
  ...
  return (<aside className='text-center'>
    <a className='resp-sharing-button__link' href={fb} target='_blank' aria-label=''>
    ...
    <a className='resp-sharing-button__link' href={tw} target='_blank' aria-label=''>
    ...
    <a className='resp-sharing-button__link' href={ml} target='_blank' aria-label=''>
    ...
    <a className='resp-sharing-button__link' href={wa} target='_blank' aria-label=''>
    ...
    <a className='resp-sharing-button__link' href={tg} target='_blank' aria-label=''>
